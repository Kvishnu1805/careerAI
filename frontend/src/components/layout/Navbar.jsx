...
const Navbar = ({ onToggleSidebar, isSidebarOpen }) => {
  ...
  return (
    <header className="sticky top-0 z-30 glass-panel border-b border-slate-200/80 dark:border-slate-800/80 dark:bg-slate-900/85 transition-all duration-200">
          ...
          <div className="flex items-center space-x-3">
            {isAuthenticated && (
              <button
                ...
                className="lg:hidden p-2 rounded-lg text-slate-600 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-slate-100 dark:hover:bg-slate-800 focus:outline-none transition-colors"
            ...
            <Link to={isAuthenticated ? "/dashboard" : "/"} className="flex items-center space-x-2.5 group">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold tracking-tight bg-gradient-to-r from-slate-900 via-indigo-950 to-indigo-700 dark:from-white dark:via-indigo-200 dark:to-indigo-400 bg-clip-text text-transparent">
                  CareerAI
                </span>
                <span className="text-[10px] uppercase tracking-wider font-semibold text-indigo-600 dark:text-indigo-400 -mt-1">
                  Interview Assistant
                </span>
              </div>
            </Link>
            ...
            {isAuthenticated ? (
              <div className="flex items-center space-x-2 sm:space-x-3">
                ...
                <button
                  ...
                  className="inline-flex items-center space-x-1.5 px-3 py-1.5 rounded-lg text-sm font-medium text-slate-600 dark:text-slate-300 hover:text-rose-600 dark:hover:text-rose-400 hover:bg-rose-50 dark:hover:bg-rose-950/30 transition-colors"
                  title="Sign Out"
                >
              ...
              <div className="flex items-center space-x-2">
                <Link
                  to="/login"
                  className="px-3.5 py-1.5 text-sm font-medium text-slate-700 dark:text-slate-300 hover:text-indigo-600 dark:hover:text-indigo-400 transition-colors"
                >
                  Sign In
                </Link>
                <Link
